# arXiv Submission Checklist: P63
...
- [ ] Check that abstract is within length limits (currently 487 characters)
- [ ] Confirm all figures are readable and properly labeled
- [ ] Verify author information is correct

### Files to Upload
- [ ] Main paper file: P63_Phylogenetic_Confidence_Cascades.md
- [ ] Abstract file: P63_abstract.txt
